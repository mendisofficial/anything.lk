...
public class CheckOut extends HttpServlet {
    ...
    private void processCheckout(Session s,
        ...
        try {
            ...
            payHereJson.addProperty("return_url", "your_return_url");
            payHereJson.addProperty("cancel_url", "your_cancel_url");
            payHereJson.addProperty("notify_url", "your_notify_url");
